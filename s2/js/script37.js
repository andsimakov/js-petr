...
// Код возьмите из предыдущего домашнего задания (script29.js)
...
const personalMovieDB = {
    ...
    rememberMyFilms: function () {
        for (let i = 0; i < 2; i++) {
            const lastWatchedMovie = prompt('Один из последних просмотренных фильмов?', '').trim(),
                lastWatchedMovieRating = prompt('На сколько оцените его?', '').trim();
    ...
    writeYourGenres: function() {
        // Обычная реализация с вводом в цикле
        // for (let i = 1; i <= 3; i++) {
        ...
        // Реализация с вводом в виде единичной строки с последующей ее разбивкой
        for (let i = 1; i < 2; i++) {
